...
app.get("api/gas/current", async (_req, res) => {
  try {
...
app.get("api/gas/recommendations", async (_req, res) => {
  try {
...
app.get("api/config/gas", (_req, res) => {
  res.json(gasService.getGasConfig());
});

app.post("api/config/gas", (req, res) => {
  try {
...
app.post("api/contract/address", (req, res) => {
  try {
...
app.post("api/test/optimize", async (req, res) => {
  try {
